...
public class AdminController {
    ...
    public ApiResponse<?> creatVocabByAdmin(
        ...
        Object response = vocabulariesService.createVocabularyByAdmin(
                authentication.getName(), req, imageFile);
    ...
    public ApiResponse<?> updateVocabByAdmin(Authentication authentication, @PathVariable Long vocabId,
            @RequestParam Long topicId,
            @RequestParam String word,
            @RequestParam String meaning,
            @RequestParam(required = false) String phonetic,
            ...
            @RequestParam(required = false) MultipartFile imageFile) {
        VocabularyRequest req = new VocabularyRequest(topicId, word, meaning, phonetic, description);
        Object response = vocabulariesService.updateVocabularyByAdmin(authentication.getName(), vocabId, req,
                imageFile);
    ...
    public ApiResponse<?> deleteVocabByAdmin(Authentication authentication, @PathVariable Long vocabId) {
        Object response = vocabulariesService.deleteVocabularyByAdmin(authentication.getName(), vocabId);
